...
def resnet_main(flags, model_function, input_function, shape=None):
    ...
    run_config = tf.estimator.RunConfig().replace(save_checkpoints_steps=10000,
    ...
    for _ in range(flags.train_epochs // flags.epochs_between_evals):
        ...
        def input_fn_train():
            return input_function('train', flags.data_dir, flags.batch_size,
                                  flags.epochs_between_evals,
        ...
        def input_fn_eval():
            return input_function('validation', flags.data_dir, flags.batch_size,
...
class ResnetArgParser(argparse.ArgumentParser):
    ...
    def __init__(self, resnet_size_choices=None):
        ...
        self.add_argument(
            ...
            help='[default: %(default)s] Predict result path'
        )
